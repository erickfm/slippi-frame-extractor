...
# --------------------
# Static mapping of melee.enums.Stage → integer codes
# Source: hohav/ssbm-data (character & stage enum constants) citeturn0search3
STAGE_MAP = {
    "NO_STAGE":             0,
...
# --------------------
# Static mapping of melee.enums.Character → integer codes
# Source: hohav/ssbm-data (character & stage enum constants) citeturn0search3
CHARACTER_MAP = {
    "MARIO":                 0,
    "FOX":                   1,
...
# --------------------
# Static mapping of melee.enums.ProjectileType → integer codes
# Source: hohav/ssbm-data (projectile enum constants) citeturn0search3
PROJECTILE_TYPE_MAP = {
    "ARROW":                     64,
    "BEAMSWORD":                 12,
    "BOB_OMB":                    6,
...
# --------------------
# Static mapping of melee.enums.Action → integer codes
# Source: melee.enums.Action definitions
# (Leave this placeholder for now; fill in with actual values when ready)
ACTION_MAP = {
    "AIRDODGE":                            236,
    "BACKWARD_TECH":                       201,
    "BAIR":                                67,
    ...
    "NESS_SHIELD":                       372,
    "NESS_SHIELD_AIR":                   373,
    "NESS_SHIELD_AIR_END":               375,
    "NESS_SHIELD_START":                 372,
    "NEUTRAL_ATTACK_1":                  44,
    "NEUTRAL_ATTACK_2":                  45,
    "NEUTRAL_ATTACK_3":                  46,
